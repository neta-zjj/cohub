...
const MOBILE_DURATION_MS = 8500;
const DESKTOP_MAX_VISIBLE = 24;
const MOBILE_MAX_VISIBLE = 10;
const THROTTLE_MS = 1500; // min gap between shown items per user
const LANE_GAP_MS = 180; // extra spacing before reusing a lane
const DESKTOP_CATCHUP_GAP_MS = 350;
const MOBILE_CATCHUP_GAP_MS = 700;
